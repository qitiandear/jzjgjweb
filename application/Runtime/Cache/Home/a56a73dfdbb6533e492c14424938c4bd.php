...
<div class="index_zhong">			
	<div style="width:797px;height:500px;clear:both;float:left;">
		...
		<div style="width:200px;float:right;padding-top:10px;position: relative;">
			<div class="info" style="position: absolute;top:-120px;left: 5px;">
				...
				<?php if(is_array($xxpm)): $k = 0; $__LIST__ = $xxpm;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><div style="font-size: 20px;line-height:30px;">
			...
			<div class="zhuanxiang_work" style="position: absolute;top: 160px;left: 5px;">
				...
				<div style="width: 150px;overflow: hidden;height:130px; ">
					<ul class="lbimg">
			...
			<div onclick="contshow()" style="width: 165px;float: right;height: 50px;background: #0068b7;text-align: center;color: #fff;margin-top: 400px;padding: 10px;cursor: pointer;margin-left: 5px;font-size:20px;">晋中市公安监管工作“11458”总体思路</div>
			<div id="contshow">
